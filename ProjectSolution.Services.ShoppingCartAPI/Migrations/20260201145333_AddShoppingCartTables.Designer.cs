...
namespace ProjectSolution.Services.ShoppingCartAPI.Migrations
{
    ...
    [Migration("20260201145333_AddShoppingCartTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectSolution.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("ProjectSolution.Services.ShoppingCartAPI.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CartsHeaders");
                });

            modelBuilder.Entity("ProjectSolution.Services.ShoppingCartAPI.Models.CartDetails", b =>
                {
                    b.HasOne("ProjectSolution.Services.ShoppingCartAPI.Models.CartHeader", "CartHeader")
                        .WithMany()
